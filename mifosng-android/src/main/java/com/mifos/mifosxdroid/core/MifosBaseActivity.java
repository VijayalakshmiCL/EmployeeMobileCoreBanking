...
//            } else {
//                Toast.makeText(this, "Permissions are required to connect to bluetooth printers", Toast.LENGTH_SHORT).show();
//            }
//        }
//    }
    ...
    @Override
    public void logout() {
        new MaterialDialog.Builder().init(MifosBaseActivity.this,R.style.Theme_MaterialComponents_Light_Dialog)
